...
func set_player(player: Player) -> void:
        ...
        if _player != null and is_instance_valid(_player):
                if _player.hp_changed.is_connected(_on_hp_changed):
                        _player.hp_changed.disconnect(_on_hp_changed)
                if _player.armor_changed.is_connected(_on_armor_changed):
                        _player.armor_changed.disconnect(_on_armor_changed)
                ...
                if _player.potions_changed.is_connected(_on_potions_changed):
                        _player.potions_changed.disconnect(_on_potions_changed)
                if _player.weapon_changed.is_connected(_on_weapon_changed):
                        _player.weapon_changed.disconnect(_on_weapon_changed)
                if _player.skill_ready_changed.is_connected(_on_skill_changed):
                        _player.skill_ready_changed.disconnect(_on_skill_changed)
        _player = player
        if _player == null:
                return
